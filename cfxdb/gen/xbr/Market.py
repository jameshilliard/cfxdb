...
def MarketAddCoin(builder, coin): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(coin), 0)
def MarketStartCoinVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddTerms(builder, terms): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(terms), 0)
def MarketAddMeta(builder, meta): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(meta), 0)
def MarketAddMaker(builder, maker): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(maker), 0)
def MarketStartMakerVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddProviderSecurity(builder, providerSecurity): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(providerSecurity), 0)
def MarketStartProviderSecurityVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddConsumerSecurity(builder, consumerSecurity): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(consumerSecurity), 0)
def MarketStartConsumerSecurityVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddMarketFee(builder, marketFee): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(marketFee), 0)
def MarketStartMarketFeeVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddTid(builder, tid): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(tid), 0)
def MarketStartTidVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddSignature(builder, signature): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(signature), 0)
